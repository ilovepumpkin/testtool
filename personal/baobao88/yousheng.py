    ...
    if os.path.exists(done_file):
        ...
        try:
            for i in range(1000):
                ...
                url=catUrl[:catUrl.rindex('_')+1]+str(j)+".html"
...
# catList=[["http://www.baobao88.com/list/101/15--181--136--.html"]]
# for cat in catList:
#     go(cat[0])

go("http://www.baobao88.com/youshen/shangxiawuqiannian/100_1.html","上下五千年")