...
subject="[lodestone730] New Build is downloaded to $local_dir_home"
  ...
  do
	for j in ${arr_release[@]}
	    	...
	    	for k in ${arr_platform[@]}
	       		do
					...
					base_build_file_name=$latest".tgz.gpg"
					 base_build_file_name_ug1=$latest"_ug1.tgz.gpg"
					...
					md5_url_2="http://w3.ssd.hursley.ibm.com/build/$j/$latest/inst.images/default/shipdata/md5sum"
					base_build_file_name_url="http://w3.ssd.hursley.ibm.com/build/$j/$latest/inst.images/default/shipdata/$base_build_file_name"
					base_build_file_name_ug1_url="http://w3.ssd.hursley.ibm.com/build/$j/$latest/inst.images/default/shipdata/$base_build_file_name_ug1"
		...
		down_build $local_latest_dir $base_build_file_name_ug1_url
			if [ $DL_PASS_FLAG -eq 0 ]
				then
					log_mail_content "${base_build_file_name_ug1} has been downloaded!"
			else
